...
const renderTodoList = () => {
    ...
    todoData.forEach(todo => {
        ...
        removeButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -8 30 30" fill="currentColor" class="w-5 h-5 mr-2 ml-2">
        ...
        editButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -8 30 30" fill="currentColor" class="w-5 h-5">
